...
EVENT_NAME_MAP = {
    ...
    "template_render_prepare": "开始准备模板生成",
    "template_render_started": "开始生成模板",
    "template_render_preview_prepare": "开始准备预览生成",
    "template_render_preview_started": "开始预览生成",
    "template_render_preview_success": "预览生成成功",
    "template_render_preview_finished": "预览生成完成",
    "template_render_preview_failed": "预览生成失败",
    "template_render_success": "模板生成成功",
    "template_render_finished": "模板生成完成",
    "template_render_failed": "模板生成失败",
